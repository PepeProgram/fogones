<?php
    ...
    class viewsModel{
        protected function obtenerVistasModelo($vista){
            ...
            $listaBlanca = ["principal", "aperitivos", "primerosPlatos", "segundosPlatos", "postres", "guarniciones", "desayunos", "complementos", "buscarRecetas", "userNew", "login", "logout", "vistaReceta", "recetasDe"];
