<?php
    ...
    class viewsModel{
        protected function obtenerVistasModelo($vista){
            ...
            $listaBlanca = ["principal", "aperitivos", "primerosPlatos", "segundosPlatos", "postres", "guarniciones", "desayunos", "complementos", "buscarRecetas", "userNew", "login", "logout", "vistaReceta", "recetasDe", "listaFiltrada"];
            ...
            if (isset($_SESSION['id']) && isset($_SESSION['nombre']) && isset($_SESSION['apellido1']) && isset($_SESSION['apellido2']) && isset($_SESSION['login']) && isset($_SESSION['foto'])) {
                ...
                if ($_SESSION['administrador']) {
                    array_push($listaBlanca, "misRecetas", "recetaData", "recetaUpdate", "paraRevisar", "panelControl", "usuarios", "recetas", "estilosCocina", "gruposPlatos", "tiposPlatos", "metodos", "utensilios", "ingredientes", "alergenos");
                }
            }
