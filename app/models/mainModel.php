...
*/
    ...
    /* MODELOS QUE PERMITEN EL CRUD */
        ...
        */
        ...
        /* Modelo para crear PAGINACIÓN en los resultados */
        /* $pagina es la página actual del listado
            $numeroPaginas el número total de páginas
            $url la url actual completa
            $botones el número máximo de botones que se mostrarán
            
            Utiliza BULMA para hacer la paginación */
        protected function paginadorTablas($pagina, $numeroPaginas, $url, $botones){
            $tabla = '<nav class="pagination is-centered is-rounded" role="navigation" aria-label="pagination">';
            /* Comprobar si está en la primera página para deshabilitar el botón anterior y colocar el primer botón de paginación */
            if ($pagina <= 1) {
                $tabla .= '
            ...
            /* Colocando el centro de los botones de paginación */
            $ci=0;
            ...
            /* Colocando el botón final y el de siguiente */
